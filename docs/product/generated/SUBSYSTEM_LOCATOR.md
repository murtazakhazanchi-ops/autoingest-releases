...
- `scripts/product-docs`
- `scripts/product-docs/bench/orchestrator`
- `scripts/product-docs/bench/results`
- `scripts/product-docs/knowledge-portal`
- `scripts/product-docs/lib`
- `scripts/product-docs/lib/askKnowledge`
- `scripts/product-docs/lib/askRetrieval`
- `scripts/product-docs/test`
- `scripts/product-docs/test/askKnowledge`
- `scripts/product-docs/test/askRetrieval`
...
- `scripts/product-docs/bench/orchestrator/retrievalStage1Performance.js`
- `scripts/product-docs/bench/orchestrator/stage2CorpusAudit.js`
- `scripts/product-docs/bench/results/retrieval-stage1-performance.json`
- `scripts/product-docs/bench/results/stage2-corpus-audit.json`
- `scripts/product-docs/cli.js`
- `scripts/product-docs/knowledge-portal/index.html`
- `scripts/product-docs/knowledge-portal/server.js`
- `scripts/product-docs/lib/askKnowledge/capabilityStatus.js`
- `scripts/product-docs/lib/askKnowledge/decisionFacts.js`
- `scripts/product-docs/lib/askKnowledge/handles.js`
- `scripts/product-docs/lib/askKnowledge/index.js`
- `scripts/product-docs/lib/askKnowledge/leakBoundary.js`
- `scripts/product-docs/lib/askKnowledge/read.js`
- `scripts/product-docs/lib/askKnowledge/relationships.js`
- `scripts/product-docs/lib/askKnowledge/roadmapStatus.js`
- `scripts/product-docs/lib/askKnowledge/search.js`
- `scripts/product-docs/lib/askKnowledge/sourcePrecedence.js`
- `scripts/product-docs/lib/askKnowledge/validators.js`
- `scripts/product-docs/lib/askRetrieval/bm25Index.js`
- `scripts/product-docs/lib/askRetrieval/canonicalAliases.js`
- `scripts/product-docs/lib/askRetrieval/fusion.js`
- `scripts/product-docs/lib/askRetrieval/queryNormalization.js`
- `scripts/product-docs/lib/askRetrieval/retrieval.js`
...
- `scripts/product-docs/test/askKnowledge/*.test.js`
- `scripts/product-docs/test/askRetrieval/*.test.js`
