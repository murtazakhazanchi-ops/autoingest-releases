...
> Generated artifact — docsys version 1.0.0. A chronological project-level narrative index over docs/product/memory/, not a duplicate of any individual capsule — open the canonical capsule (linked below) for the full record. Never edit this file by hand — regenerate with `node scripts/product-docs/cli.js build`.
